...
/*
	Purpose: execute and write output to CSV file for High School simple movement algorithm
*/
class SimpleMovementHS_Alg
{
private:
...
public:
	SimpleMovementHS_Alg(float pSimulatedTime, float pDeltaTime, string pOutputFileName);	//will take a struct of required input data and load the class data
